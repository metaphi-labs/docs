---
title: "Plugins"
description: "A plugin is a directory that bundles skills, agents, hooks, tool servers and language servers. Hum reads the layout Claude Code's plugins use, unchanged, so a plugin written for either works in both."
---
