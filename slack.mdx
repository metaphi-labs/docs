...
A Slack workspace admin clicks **Add to Slack** at [metaphi.ai/humboldt](https://metaphi.ai/humboldt) and approves the permissions. Slack returns to a page that says the workspace is in and shows the two steps left. No Humboldt account is needed to install.
