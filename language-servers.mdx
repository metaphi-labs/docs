...
description: "Humboldt reads the code the way the compiler does when a language server is there: where a symbol is defined, who references it, what a name is, what the parser complains about."
---
