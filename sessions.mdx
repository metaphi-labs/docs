...
Humboldt compacts at four fifths of the model's window or 200,000 tokens, whichever comes first. Older tool results are trimmed first. If still over, the conversation becomes a handoff note and continues from it. Your goal, the plan and the last turns cross over.
